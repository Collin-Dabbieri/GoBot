...
files_dir=''                         # path to directory where training data, validation data, and partition file are located
filename_partition=''                # filename of partition file
...
if __name__=='__main__':
    ...
    partition=pickle.load(open(files_dir+filename_partition,"rb"))
    size_train=len(partition['train'])
    size_validation=len(partition['validation'])
    
    #load in generators for training and validation
    training_generator = DataGeneratorTrain(filenames=partition['train'],
                                            shuffle=args.shuffle)
    validation_generator = DataGeneratorTrain(filenames=partition['validation'],
    ...
    fp=open("{:s}{:s}_results.pkl".format(results_dir,fbase),"wb")
